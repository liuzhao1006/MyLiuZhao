...
/**
 * Created by xxxxxx on 2017/12/19.
 */

public class CompanyAndMonthBean implements Serializable {
    ...
    private int handleCountOtherRate;
    ...
    public int getHandleCountOtherRate() {
        return handleCountOtherRate;
    }

    public void setHandleCountOtherRate(int handleCountOtherRate) {

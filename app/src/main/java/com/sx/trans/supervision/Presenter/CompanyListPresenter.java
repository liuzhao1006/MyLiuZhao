...
public class CompanyListPresenter {
    ...
    private static final String TAG = "CompanyListPresenter";
    private Result result;


    public CompanyListPresenter(PublicView mView, Context _context) {
        this.mView = mView;
        this.mContext = _context;
    }

    public void getCompanyList(int tid,String unitName,int limit,int page) {
        ...
        OkHttpUtils
                ...
                .url(UrlConstants.GET_COMPANY_LIST + LzApp.mSpfProxy.getInt(IConstants.mSpre_Constants.UID, -1)+"/"+ LzApp.mSpfProxy.getString(IConstants.mSpre_Constants.USER_AREACODE, "")+"/"+tid)
                .params(params)
                .build()//

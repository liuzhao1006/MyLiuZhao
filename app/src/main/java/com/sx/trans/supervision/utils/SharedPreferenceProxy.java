...
/**
 * Created by etrans on 2015/12/4.
 * <p/>
 * SharedPreferences和Editor的代理类，把这两个接口统一放一起，简化代码
 */
final public class SharedPreferenceProxy implements SharedPreferences, Editor {

    private SharedPreferences mSharedPreferences;
    private Editor mEditor;

    private SharedPreferenceProxy(Context context, String name) {
//        mSharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
    ...
    public static SharedPreferenceProxy getInstance(Context context,
                                                    String name) {
        return new SharedPreferenceProxy(context, name);
    }

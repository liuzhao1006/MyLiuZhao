 ...
 */
public class LzTypeface extends View {
    ...
    public LzTypeface(Context context) {
        super(context);
        init();
    }

    public LzTypeface(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LzTypeface(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public LzTypeface(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {

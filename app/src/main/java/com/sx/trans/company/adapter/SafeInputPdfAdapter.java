...
public class SafeInputPdfAdapter extends BaseAdapter {
...
//    private int i;
    ...
    public SafeInputPdfAdapter(int layoutResId, List data, String time,Context context) {
               ...
               final String  path=filePath;
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        bundle.putSerializable("pdfContent", new PdfBean(title[0],path,time));

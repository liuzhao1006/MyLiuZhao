...
public class NoticePdfAdapter extends BaseAdapter {
    ...
    //假数据
    private int i;
    private QueryNoticeMessage.DataBean data1;

    public NoticePdfAdapter(int layoutResId, List data, Context context) {
    ...
    protected void bindTheData(final RecyclerView.ViewHolder holder, Object data, int position) {
        ...
        data1 = (QueryNoticeMessage.DataBean) data;
        final String[] title = data1.getFileInfo().split("::");
...
//                        bundle.putSerializable("pdfContent", new PdfBean(title[0],data1.getAmount() ));

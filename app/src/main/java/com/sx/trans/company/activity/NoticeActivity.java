...
import com.sx.trans.transport.dynamicMonitoring.activity.NoticeMessActivity;
...
public class NoticeActivity extends BaseTransActivity implements BaseNetApi {
    ...
    private void httpClick() {
        ...
        manager.setqueyNotice(new CompanyManager.QueryNoticedata() {
            @Override
    ...
    public void setCommonContract(final List<QueryNoticeMessage.DataBean> mList){
        if (mAdapter!=null){

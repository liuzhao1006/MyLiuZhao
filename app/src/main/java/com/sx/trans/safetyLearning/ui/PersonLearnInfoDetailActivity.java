...
import com.sx.trans.company.adapter.CompeletePersonDetailAdapter;
...
/**
 * Created by xxxxxx on 2018/2/6.
 */

public class PersonLearnInfoDetailActivity extends BaseTransActivity implements BaseNetApi, OnChartValueSelectedListener, View.OnClickListener, OnDateSetListener {
    ...
    private  CompeletePersonDetailAdapter  adapter;
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDialogYearMonth = new TimePickerDialog.Builder()
                ...
                .setThemeColor(getResources().getColor(R.color.title_ground_normal))
                .setCallBack(PersonLearnInfoDetailActivity.this)
...
//
    ...
    private void setCommonContract(List mList) {
        mList.add("1");
        mList.add("1");
        adapter = new CompeletePersonDetailAdapter(R.layout.item_compelete_person_detail, mList,PersonLearnInfoDetailActivity.this);

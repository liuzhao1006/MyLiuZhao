...
public class EmployeeCompletionRateActivity extends BaseTransActivity implements BaseNetApi, OnChartValueSelectedListener, View.OnClickListener {
    ...
    private CompeleteRateAdapter adapter;
    ...
    protected int getContentViewLayoutID() {
        return R.layout.activity_rate_learncomplete;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        leftGoBack(this);
        layoutTopModleinfo.setText("从业人员完成率");
...
//
    ...
    private void setCommonContract(List mList) {
        mList.add("1");
        mList.add("1");
        adapter = new CompeleteRateAdapter(R.layout.item_compelete_rate, mList);
        rlv.setAdapter(adapter);
        adapter.setItemClickListener(new BaseAdapter.onItemClickListener() {
            @Override
            public void onItemClick(int position, View v) {
                Intent intent = new Intent(EmployeeCompletionRateActivity.this, EmployeeCompletionRateDtailActivity.class);

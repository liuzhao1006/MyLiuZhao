...
public class MailBoxActivity extends BaseTransActivity implements BaseNetApi {
    ...
    private List<CQueryLeaderMailbox.DataBean> mList = new ArrayList<>();
...
//        httpClick();
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        TextView r = findViewById(R.id.layout_top_righttextinfo);
        ...
        r.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //发送邮件
                startActivity(new Intent(MailBoxActivity.this, MeSendMailboxActivity.class));
            }
        });
        leftGoBack(this);
        setRefreshViewData();
    ...
    private void httpClick() {
        ...
        manager.getLeaderMailbox(pageNum, pageSize);
        manager.setQueryLeaderMData(new EmployeesManager.QuertyLeadMdata() {
            @Override
            public void onQueryData(int what, List<CQueryLeaderMailbox.DataBean> rulesList) {
    ...
    private void setCommonContract(final List<CQueryLeaderMailbox.DataBean> mList) {
        if (mAdapter != null) {
        ...
        mAdapter.setItemClickListener(new BaseAdapter.onItemClickListener() {
            ...
            public void onItemClick(int position, View v) {
                //跳转到详情
                Intent intent = new Intent(MailBoxActivity.this, CongMeLeadershipMailboxActivity.class);

 ...
 * 地方法律法规
 */
public class LawsAndegulationRsActivity extends BaseTransActivity implements BaseNetApi {
            ...
            public void onRulesData(int what, List<LawBean> rulesList) {
                ...
                mAdapter.setItemClickListener(new BaseAdapter.onItemClickListener() {
                    ...
                    public void onItemClick(int position, View v) {
                        Intent intent = new Intent(LawsAndegulationRsActivity.this, StudentEnterPriseDetialActivity.class);
